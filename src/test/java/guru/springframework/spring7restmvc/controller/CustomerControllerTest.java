...
class CustomerControllerTest {
    ...
    void testDeleteCustomer() throws Exception {
        ...
        mockMvc.perform(delete(CustomerController.CUSTOMER_PATH_WITH_ID, customer.getId())
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isNoContent());
...
//        System.out.println(objectMapper.writeValueAsString(customerServiceImpl.getAllCustomers().get(0)));
    ...
    void getCustomerById() throws Exception {
        ...
        mockMvc.perform(get(CustomerController.CUSTOMER_PATH_WITH_ID, testCustomer.getId())
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
